...
public partial class MainWindow
{
	...
	protected virtual void Build ()
	{
		...
		this.hpaned1.Position = 34;
		// Container child hpaned1.Gtk.Paned+PanedChild
		this.UIManager.AddUiFromString ("<ui><toolbar name='toolbar1'><toolitem name='newAction' action='newAction'/><toolitem name='openAction' action='openAction'/><toolitem name='saveAction' action='saveAction'/><toolitem name='deleteAction1' action='deleteAction1'/><toolitem name='printAction' action='printAction'/><toolitem name='undoAction' action='undoAction'/><toolitem name='redoAction' action='redoAction'/><toolitem name='preferencesAction' action='preferencesAction'/><toolitem name='quitAction' action='quitAction'/></toolbar></ui>");
		this.toolbar1 = ((global::Gtk.Toolbar)(this.UIManager.GetWidget ("/toolbar1")));
		this.toolbar1.Name = "toolbar1";
		this.toolbar1.Orientation = ((global::Gtk.Orientation)(1));
		this.toolbar1.ShowArrow = false;
		this.hpaned1.Add (this.toolbar1);
		global::Gtk.Paned.PanedChild w3 = ((global::Gtk.Paned.PanedChild)(this.hpaned1 [this.toolbar1]));
		w3.Resize = false;
		// Container child hpaned1.Gtk.Paned+PanedChild
